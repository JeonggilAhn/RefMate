  ...
  const tutorialSteps = [
    {
      title: '핀 생성 모드',
      content:
        '핀 버튼이나 ctrl 을 눌러 핀 모드로 전환 후, 원하는 곳에 핀을 찍어보세요.',
      top: '',
      left: '50%',
      bottom: '-10px',
      right: '',
    },
    {
      title: '이동 모드',
      content:
        '도면을 자유롭게 이동해보세요. 마우스 휠을 사용해 확대/축소도 가능합니다.',
      top: '',
      left: '50%',
      bottom: '-10px',
      right: '',
    },
    {
      title: '버전 이동 및 생성',
      content:
        '이전 버전의 기록을 확인하거나, 새로운 버전 업로드가 가능합니다.',
      top: '',
      left: '50%',
      bottom: '100px',
      right: '',
    ...
    },
    {
      title: '전체 사이드바 툴',
      content:
        '사이드바를 열고 닫을 수 있습니다. 핀/노트/이미지를 한 번에 닫을 수 있습니다.',
      top: '150px',
      left: '',
      bottom: '',
      right: '160px',
    },
    {
      title: '핀 위치 추적',
      content:
        '폴더 제목을 클릭하면, 해당 핀이 어디에 위치해 있는지 알 수 있습니다',
      top: '315px',
      left: '',
      bottom: '',
      right: '160px',
    },
    {
      title: '핀 완료/미완료',
      content:
        '논의가 종료된 핀은 완료 처리할 수 있으며, 완료된 핀을 다시 미완료 상태로도 변경 가능합니다.',
      top: '245px',
      left: '',
      bottom: '',
      right: '160px',
    },
    {
      title: '핀 노트/이미지 상세',
      content:
        '핀을 클릭하면 드래그가 가능한 창이 떠요. 창 좌측 상단의 아이콘 클릭을 통해 노트/이미지 상세를 같이 볼 수도 있고, 개별로도 볼 수 있어요.',
      top: '190px',
      left: '',
      bottom: '',
      right: '180px',
    },
    {
      title: '상세 사이드바',
      content:
        '좌측 상단의 아이콘을 누르면 해당 창이 닫히고, 중요 노트, 핀 노트, 핀 레퍼런스를 사이드바에서 볼 수 있어요.',
      top: '220px',
      left: '',
      bottom: '',
      right: '180px',
